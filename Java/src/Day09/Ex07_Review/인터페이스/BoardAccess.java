...
public class BoardAccess implements BoardInterface {
	...
	// 게시글 목록
	Board[] boardList = {
			new Board(01, "제목01", "작성자01", "내용01", "2024/08/20 - 10:00", "2024/08/20 - 10:00"),
			new Board(02, "제목02", "작성자02", "내용02", "2024/08/20 - 10:00", "2024/08/20 - 10:00"),
			new Board(03, "제목03", "작성자03", "내용03", "2024/08/20 - 10:00", "2024/08/20 - 10:00"),
			new Board(04, "제목04", "작성자04", "내용04", "2024/08/20 - 10:00", "2024/08/20 - 10:00"),
			new Board(05, "제목05", "작성자05", "내용05", "2024/08/20 - 10:00", "2024/08/20 - 10:00"),
	};
	
	/**
	 * 게시글 등록
	 * 1. 매개변수로 넘겨받음 board 객체에 게시글 번호를 부여한다.
	...
	/**
	 * 게시글 조회
	 * 1. 넘겨밭은 게시글 번호 no 가 유효하지 않으면, null 반환
	 * 2. 게시글 번호 no 가 유효하면, 
	...
	public int update(Board board) {
		...
		String updateTiltle = board.getTitle();
		String updateWriter = board.getWriter();
		String updareContent = board.getContent();
		
		// 수정할 정보만 변경
		oldBoard.setTitle(updateTiltle);
		oldBoard.setWriter(updateWriter);
		oldBoard.setContent(updareContent);
