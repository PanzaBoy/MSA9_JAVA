...
public class ComparatorEx {
	public static void main(String[] args) {
		List<User> userList = Arrays.asList(
			new User("rung1004", "배령영", 31),
			new User("young4885", "영이", 25),
			new User("yabi1234", "야비영", 27),
			new User("eun564", "배은영", 30),
			new User("baehayoung584", "배하영", 21),
			new User("jjang567", "배짱이", 20),
			new User("bae2", "배이가", 43),
			new User("hwan2", "배선환", 55)
		);
