...
public class Course <T> implements Manager {
	...
	public void setStudent(List<T> students) {
		this.students = students;
	}
	...
	@Override
	public Course<?> createWokerCourse(String name, Course<? super Worker> course) {
		course.setName(name);
		// 직장인 과정 생성 시, 프로세스
	...
	public void printStudentList(Course<?> course) {
		...
		List<Object> studentList = (List<Object>) course.getStudent();
